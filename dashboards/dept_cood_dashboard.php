...
<body> 
 ...
 <!-- <h1 id="h1"> K.J SOMAIYA SCHOOL OF ENGINEERING</h1>
...
<div id="outer">
	...
	<div id="main" style=" width: 80vw; margin-left: 5vw;">
		...
		<div id="content" class="content">
			<br>
			<button  id="back" style="display: none; position:fixed; bottom:30px; z-index: 999999;" class="btn btn-success">Back</button>
...
<div id="summary_rep" style="display: none;">
	<div class="table-wrapper" id="table_summary">
		<div class="table-title">
			<div class="row">
				<button  id="back_report" style="display: none; position:fixed; bottom:30px; z-index: 999999" class="btn btn-success" onclick="openReport()">Back</button>
...
<div id="semwise_course_rep" style="display: none;">
	<div class="table-wrapper" id="table_summary">
		<div class="table-title">
			<div class="row">
				<button  id="back_semwise_report" style="display: none; position:fixed; bottom:30px; z-index: 999999" class="btn btn-success" onclick="openReport()">Back</button>
...
<div id="content1" class="content1">
	...
	<br>
	<p><b>
		<select id="classOfReminderStudent" class="select_class_for_mail">
			<option disabled selected value value="base">Choose Class</option>
			<option value="FY_A" <?php if($dept_id!=6){ ?> hidden <?php } ?>>FY Group C</option>
			<option value="FY_B" <?php if($dept_id!=6){ ?> hidden <?php } ?>>FY Group P</option>
			...
			<option value="MTech RA" <?php if($dept_id!=7){ ?> hidden <?php } ?>>MTech RA</option>
		...
		$(".select_class_for_mail").change( function() {
				...
				document.getElementById('divA_2').style.display = 'none';
				document.getElementById('divB_2').style.display = 'none';
				document.getElementById('divC_2').style.display = 'none';
				document.getElementById('divC_comp2').style.display = 'none';
				document.getElementById('divC_comp5').style.display = 'none';
				
				document.getElementById('divA_2p').style.display = 'none';
				document.getElementById('divB_2p').style.display = 'none';
				document.getElementById('divC_2p').style.display = 'none';

				document.getElementById('divD_2').style.display = 'none';
				document.getElementById('divE_2').style.display = 'none';
				document.getElementById('divE_2C1').style.display = 'none';
				document.getElementById('divE_2C2').style.display = 'none';

				document.getElementById('divF_2').style.display = 'none';
				document.getElementById('divG_2').style.display = 'none';
				document.getElementById('divH_2').style.display = 'none';
				document.getElementById('divI_2').style.display = 'none';
				document.getElementById('divJ_2').style.display = 'none';
				document.getElementById('divJ_2p').style.display = 'none';
				document.getElementById('divJ_2p1').style.display = 'none';
				document.getElementById('divJ_2p2').style.display = 'none';

			var op = $(this).children("option:selected").val();
			var deptId = <?php echo $dept_id ?>;
			if(op=='FY_A')
			{

				document.getElementById('divA_2p').style.display = 'block';
				document.getElementById('divB_2p').style.display = 'block';
				document.getElementById('divC_2p').style.display = 'block';
				document.getElementById('divD_2').style.display = 'block';
				document.getElementById('divE_2').style.display = 'block';
				document.getElementById('divE_2C1').style.display = 'block';
				document.getElementById('divE_2C2').style.display = 'block';
				
				document.getElementById('divF_2').style.display = 'block';
				document.getElementById('divG_2').style.display = 'block';
				document.getElementById('divH_2').style.display = 'block';
				document.getElementById('divI_2').style.display = 'block';
				document.getElementById('divJ_2').style.display = 'block';
				document.getElementById('divJ_2p').style.display = 'block';
				document.getElementById('divJ_2p1').style.display = 'block';
				document.getElementById('divJ_2p2').style.display = 'block';
			...
			else if(op=='SY')
			{
				...
				document.getElementById('divA_2').style.display = 'block';
				document.getElementById('divB_2').style.display = 'block';
				if (deptId==1)
				{
				  document.getElementById('divC_2').style.display = 'block';
				  document.getElementById('divC_comp2').style.display = 'block';
				  document.getElementById('divC_comp5').style.display = 'block';
				}
			}
			else if(op=='TY')
			{
		...
		<select id="sectionOFReminderStudent">
			...
			<option value="A" id="divA_2">A</option>
			<option value="B" id="divB_2" >B</option>
			<option value="C" id="divC_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C</option>
			<option value="D" id="divC_comp2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D</option>
			<option value="E" id="divC_comp5" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E</option>

			<option value="A" id="divA_2p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>A</option>
			<option value="B" id="divB_2p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>B</option>
			<option value="C" id="divC_2p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C</option>
			<option value="D" id="divD_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D</option>
			<option value="E" id="divE_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E</option>
			<option value="F" id="divE_2C1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F</option>
			<option value="G" id="divE_2C2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G</option>

			<option value="H" id="divF_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H</option>
			<option value="I" id="divG_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I</option>
			<option value="J" id="divH_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J</option>
			<option value="K" id="divI_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K</option>
			<option value="L" id="divJ_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L</option>	
			<option value="M" id="divJ_2p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M</option>
			<option value="N" id="divJ_2p1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N</option>
			<option value="O" id="divJ_2p2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O</option>			
		</select>
	</b>
	...
	<div class="table-wrapper" id="table123">
		...
		<p><b>
			...
			<script type="text/javascript">
				$(".select_class2").change( function() {
					...
					document.getElementById('ly2_2').style.display = 'none';
						...
						document.getElementById('divC_comp').style.display = 'none';
						document.getElementById('divC_comp51').style.display = 'none';
						...
						document.getElementById('divEC1').style.display = 'none';
						document.getElementById('divEC2').style.display = 'none';
						...
						document.getElementById('divJp').style.display = 'none';
						document.getElementById('divJp1').style.display = 'none';
						document.getElementById('divJp2').style.display = 'none';
						...
						document.getElementById('divC1_comp').style.display = 'none';
						document.getElementById('divC2_comp').style.display = 'none';
						document.getElementById('divC3_comp').style.display = 'none';
						document.getElementById('divC4_comp').style.display = 'none';
						
						document.getElementById('divC1_comp51').style.display = 'none';
						document.getElementById('divC2_comp51').style.display = 'none';
						document.getElementById('divC3_comp51').style.display = 'none';
						document.getElementById('divC4_comp51').style.display = 'none';
						

						document.getElementById('divA1p').style.display = 'none';
						document.getElementById('divA2p').style.display = 'none';
						document.getElementById('divA3p').style.display = 'none';

						document.getElementById('divB1p').style.display = 'none';
						document.getElementById('divB2p').style.display = 'none';
						document.getElementById('divB3p').style.display = 'none';

						document.getElementById('divC1p').style.display = 'none';
						document.getElementById('divC2p').style.display = 'none';
						document.getElementById('divC3p').style.display = 'none';

						document.getElementById('divD1').style.display = 'none';
						document.getElementById('divD2').style.display = 'none';
						document.getElementById('divD3').style.display = 'none';
						...
						document.getElementById('divE61').style.display = 'none';
						document.getElementById('divE62').style.display = 'none';
						document.getElementById('divE63').style.display = 'none';

						document.getElementById('divE71').style.display = 'none';
						document.getElementById('divE72').style.display = 'none';
						document.getElementById('divE73').style.display = 'none';
						...
						document.getElementById('divG1').style.display = 'none';
						document.getElementById('divG2').style.display = 'none';
						document.getElementById('divG3').style.display = 'none';

						document.getElementById('divH1').style.display = 'none';
						document.getElementById('divH2').style.display = 'none';
						document.getElementById('divH3').style.display = 'none';
						...
						document.getElementById('divP71').style.display = 'none';
						document.getElementById('divP72').style.display = 'none';
						document.getElementById('divP73').style.display = 'none';
						document.getElementById('divP74').style.display = 'none';
						
						document.getElementById('divP81').style.display = 'none';
						document.getElementById('divP82').style.display = 'none';
						document.getElementById('divP83').style.display = 'none';
					...
					if(op=='FY_A')
					{
						...
						document.getElementById('divEC1').style.display = 'block';
						document.getElementById('divEC2').style.display = 'block';
						...
						document.getElementById('divJp').style.display = 'block';
						document.getElementById('divJp1').style.display = 'block';
						document.getElementById('divJp2').style.display = 'block';


						document.getElementById('divA1p').style.display = 'block';
						document.getElementById('divA2p').style.display = 'block';
						document.getElementById('divA3p').style.display = 'block';

						document.getElementById('divB1p').style.display = 'block';
						document.getElementById('divB2p').style.display = 'block';
						document.getElementById('divB3p').style.display = 'block';

						document.getElementById('divC1p').style.display = 'block';
						document.getElementById('divC2p').style.display = 'block';
						document.getElementById('divC3p').style.display = 'block';

						document.getElementById('divD1').style.display = 'block';
						document.getElementById('divD2').style.display = 'block';
						document.getElementById('divD3').style.display = 'block';
						...
						document.getElementById('divE61').style.display = 'block';
						document.getElementById('divE62').style.display = 'block';
						document.getElementById('divE63').style.display = 'block';

						document.getElementById('divE71').style.display = 'block';
						document.getElementById('divE72').style.display = 'block';
						document.getElementById('divE73').style.display = 'block';
						...
						document.getElementById('divG1').style.display = 'block';
						document.getElementById('divG2').style.display = 'block';
						document.getElementById('divG3').style.display = 'block';

						document.getElementById('divH1').style.display = 'block';
						document.getElementById('divH2').style.display = 'block';
						document.getElementById('divH3').style.display = 'block';
						...
						document.getElementById('divP71').style.display = 'block';
						document.getElementById('divP72').style.display = 'block';
						document.getElementById('divP73').style.display = 'block';
						document.getElementById('divP74').style.display = 'block';
						
						document.getElementById('divP81').style.display = 'block';
						document.getElementById('divP82').style.display = 'block';
						document.getElementById('divP83').style.display = 'block';
					...
					else if(op=='SY')
					{
						...
						document.getElementById('divC_comp').style.display = 'block';
						document.getElementById('divC_comp51').style.display = 'block';
						}
						...
						document.getElementById('divA4').style.display = 'block';
						...
						if (deptId==1){
							...
							document.getElementById('divC1_comp').style.display = 'block';
							document.getElementById('divC2_comp').style.display = 'block';
							document.getElementById('divC3_comp').style.display = 'block';
							document.getElementById('divC4_comp').style.display = 'block';
							
							document.getElementById('divC1_comp51').style.display = 'block';
							document.getElementById('divC2_comp51').style.display = 'block';
							document.getElementById('divC3_comp51').style.display = 'block';
							document.getElementById('divC4_comp51').style.display = 'block';
			...
			<select id="section">
				<option disabled selected value value="base">Choose Section</option>
				<!-- <option value="All">All</option> -->
				<option value="A" id="divA" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>A</option>
				<option value="B" id="divB" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>B</option>
				<option value="C" id="divC" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>C</option>
				<option value="D" id="divC_comp" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>D</option>
				<option value="E" id="divC_comp51" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>E</option>

				<option value="A" id="divAp" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>A</option>
				<option value="B" id="divBp" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>B</option>
				<option value="C" id="divCp" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C</option>
				<option value="D" id="divD" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D</option>
				<option value="E" id="divE" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E</option>
				<option value="F" id="divEC1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F</option>
				<option value="G" id="divEC2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G</option>

				<option value="H" id="divF" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H</option>
				<option value="I" id="divG" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I</option>
				<option value="J" id="divH" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J</option>
				<option value="K" id="divI" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K</option>
				<option value="L" id="divJ" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L</option>
				<option value="M" id="divJp" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M</option>	
				<option value="N" id="divJp1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N</option>
				<option value="O" id="divJp2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O</option>

				<option value="A1" id="divA1" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>A1</option>
				<option value="A2" id="divA2" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>A2</option>
				<option value="A3" id="divA3" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>A3</option>
				<option value="A4" id="divA4" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>A4</option>

				<option value="B1" id="divB1" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>B1</option>
				<option value="B2" id="divB2" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>B2</option>
				<option value="B3" id="divB3" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>B3</option>
				<option value="B4" id="divB4" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>B4</option>

				<option value="C1" id="divC1" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>C1</option>
				<option value="C2" id="divC2" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>C2</option>
				<option value="C3" id="divC3" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>C3</option>
				<option value="C4" id="divC4" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>C4</option>

				<option value="D1" id="divC1_comp" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>D1</option>
				<option value="D2" id="divC2_comp" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>D2</option>
				<option value="D3" id="divC3_comp" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>D3</option>
				<option value="D4" id="divC4_comp" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>D4</option>

                <option value="E1" id="divC1_comp51" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>E1</option>
				<option value="E2" id="divC2_comp51" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>E2</option>
				<option value="E3" id="divC3_comp51" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>E3</option>
				<option value="E4" id="divC4_comp51" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>E4</option>


				<option value="A1" id="divA1p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>A1</option>
				<option value="A2" id="divA2p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>A2</option>
				<option value="A3" id="divA3p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>A3</option>

				<option value="B1" id="divB1p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>B1</option>
				<option value="B2" id="divB2p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>B2</option>
				<option value="B3" id="divB3p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>B3</option>
		
				<option value="C1" id="divC1p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C1</option>
				<option value="C2" id="divC2p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C2</option>
				<option value="C3" id="divC3p" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C3</option>

				<option value="D1" id="divD1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D1</option>
				<option value="D2" id="divD2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D2</option>
				<option value="D3" id="divD3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D3</option>
				
				<option value="E1" id="divE1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E1</option>
				<option value="E2" id="divE2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E2</option>
				<option value="E3" id="divE3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E3</option>

				<option value="F1" id="divE61" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F1</option>
				<option value="F2" id="divE62" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F2</option>
				<option value="F3" id="divE63" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F3</option>

				<option value="G1" id="divE71" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G1</option>
				<option value="G2" id="divE72" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G2</option>
				<option value="G3" id="divE73" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G3</option>

				<option value="H1" id="divF1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H1</option>
				<option value="H2" id="divF2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H2</option>
				<option value="H3" id="divF3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H3</option>

				<option value="I1" id="divG1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I1</option>
				<option value="I2" id="divG2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I2</option>
				<option value="I3" id="divG3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I3</option>

				<option value="J1" id="divH1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J1</option>
				<option value="J2" id="divH2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J2</option>
				<option value="J3" id="divH3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J3</option>

				<option value="K1" id="divI1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K1</option>
				<option value="K2" id="divI2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K2</option>
				<option value="K3" id="divI3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K3</option>

				<option value="L1" id="divJ1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L1</option>
				<option value="L2" id="divJ2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L2</option>
				<option value="L3" id="divJ3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L3</option>

				<option value="M1" id="divP1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M1</option>
				<option value="M2" id="divP2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M2</option>
				<option value="M3" id="divP3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M3</option>
			
				<option value="N1" id="divP71" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N1</option>
				<option value="N2" id="divP72" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N2</option>
				<option value="N3" id="divP73" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N3</option>
				<option value="N4" id="divP74" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N4</option>
				
				
				<option value="O1" id="divP81" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O1</option>
				<option value="O2" id="divP82" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O2</option>
				<option value="O3" id="divP83" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O3</option>
						...
						<div style="width: 100%"  class="tab-content">
							<div style="width: 100%" class="tab-pane fade in active" style="text-align: center;" id="tab1_student">
								<div style="width: 100%"  id="showStudent">
									...
									<p><b>
										<select id="classOfStudent" class="select_class_for_edit">
											<option disabled selected value value="base">Choose Class</option>
											<option value="FY_A" <?php if($dept_id!=6){ ?> hidden <?php } ?>>FY Group C</option>
											<option value="FY_B" <?php if($dept_id!=6){ ?> hidden <?php } ?>>FY Group P</option>
											<option value="SY" <?php if($dept_id==6){ ?> hidden <?php } ?>>SY</option>
										...
										<script type="text/javascript">
											$(".select_class_for_edit").change( function() {
													...
													document.getElementById('divA_1').style.display = 'none';
													document.getElementById('divB_1').style.display = 'none';
													document.getElementById('divC_1').style.display = 'none';
													document.getElementById('divC_comp1').style.display = 'none';
													document.getElementById('divC_comp15').style.display = 'none';
													
													document.getElementById('divA_1p').style.display = 'none';
													document.getElementById('divB_1p').style.display = 'none';
													document.getElementById('divC_1p').style.display = 'none';

													document.getElementById('divD_1').style.display = 'none';
													document.getElementById('divE_1').style.display = 'none';
													document.getElementById('divE_1C1').style.display = 'none';
													document.getElementById('divE_1C2').style.display = 'none';

													document.getElementById('divF_1').style.display = 'none';
													document.getElementById('divG_1').style.display = 'none';
													document.getElementById('divH_1').style.display = 'none';
													document.getElementById('divI_1').style.display = 'none';
													document.getElementById('divJ_1').style.display = 'none';
													document.getElementById('divJ_1p').style.display = 'none';
													document.getElementById('divJ_1p1').style.display = 'none';
													document.getElementById('divJ_1p2').style.display = 'none';
												...
												if(op=='FY_A')
												{
													...
													document.getElementById('divA_1p').style.display = 'block';
													document.getElementById('divB_1p').style.display = 'block';
													document.getElementById('divC_1p').style.display = 'block';
													document.getElementById('divD_1').style.display = 'block';
													document.getElementById('divE_1').style.display = 'block';
													document.getElementById('divE_1C1').style.display = 'block';
													document.getElementById('divE_1C2').style.display = 'block';
													
													document.getElementById('divF_1').style.display = 'block';
													document.getElementById('divG_1').style.display = 'block';
													document.getElementById('divH_1').style.display = 'block';
													document.getElementById('divI_1').style.display = 'block';
													document.getElementById('divJ_1').style.display = 'block';
													document.getElementById('divJ_1p').style.display = 'block';
													document.getElementById('divJ_1p1').style.display = 'block';
													document.getElementById('divJ_1p2').style.display = 'block';
												...
												else if(op=='SY')
												{
													...
													document.getElementById('divA_1').style.display = 'block';
													document.getElementById('divB_1').style.display = 'block';
													if (deptId==1)
													{
													document.getElementById('divC_1').style.display = 'block';
													document.getElementById('divC_comp1').style.display = 'block';
													document.getElementById('divC_comp15').style.display = 'block';
													}
												}
												else if(op=='TY')
												{
										...
										<select id="sectionOFStudent">
											<option disabled selected value value="base">Choose Section</option>
											<!-- <option value="All">All</option> -->
											<option value="A" id="divA_1">A</option>
											<option value="B" id="divB_1">B</option>
											<option value="C" id="divC_1">C</option>
											<option value="D" id="divC_comp1">D</option>
											<option value="E" id="divC_comp15">E</option>
											
											<option value="A" id="divA_1p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>A</option>
											<option value="B" id="divB_1p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>B</option>
											<option value="C" id="divC_1p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>C</option>
											<option value="D" id="divD_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>D</option>
											<option value="E" id="divE_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>E</option>
											<option value="F" id="divE_1C1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F</option>
											<option value="G" id="divE_1C2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G</option>
											<option value="H" id="divF_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H</option>
											<option value="I" id="divG_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I</option>
											<option value="J" id="divH_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J</option>
											<option value="K" id="divI_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K</option>
											<option value="L" id="divJ_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L</option>
											<option value="M" id="divJ_1p" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M</option>
											<option value="N" id="divJ_1p1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N</option>
											<option value="O" id="divJ_1p2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O</option>											
										</select>
									</b>
									...
									<h3>
										<div class="form-group">
											...
											<select name="section" id="student_section">
												...
												<option value="A" <?php if($dept_id==6){ ?> hidden <?php } ?>>A</option>
												<option value="B" <?php if($dept_id==6){ ?> hidden <?php } ?>>B</option>
												...
												<option value="K" <?php if($dept_id!=6){ ?> hidden <?php } ?>>K</option>
												<option value="L" <?php if($dept_id!=6){ ?> hidden <?php } ?>>L</option> 
												<option value="M" <?php if($dept_id!=6){ ?> hidden <?php } ?>>M</option>
												<option value="N" <?php if($dept_id!=6){ ?> hidden <?php } ?>>N</option>  
												<option value="O" <?php if($dept_id!=6){ ?> hidden <?php } ?>>O</option> 												
											</select>
											<script type="text/javascript">
