...
if($_SESSION['class']=='SY' or $_SESSION['class']=='FY_A' or $_SESSION['class']=='FY_B' or $_SESSION['class']=='LY'or $_SESSION['class']=='TY' or $_SESSION['class']=='MTech Comp' or $_SESSION['class']=='MTech IT' or $_SESSION['class']=='MTech ETRX' or $_SESSION['class']=='MTech EXTC' or $_SESSION['class']=='MTech Mech'){
    ...
    <div id="main" style=" width: 80vw; margin-left: 5vw;">
      <div id="info">
        ...
        <script type="text/javascript">
          ...
          <?php
             if ($_SESSION['class']=="FY_A" || $_SESSION['class']=="FY_B")
             $class_for_print="FY";
             else
             $class_for_print=$_SESSION['class'];
          ?>
          ...
          document.getElementById("studentclass").innerHTML=<?php echo json_encode($class_for_print); ?>;
