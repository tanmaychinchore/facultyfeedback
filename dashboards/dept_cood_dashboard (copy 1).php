...
<div id="content1" class="content1">
	...
	<p><b>
		...
		<select id="sectionOFReminderStudent">
			...
			<option value="F" id="divF_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F</option>
			<option value="G" id="divG_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G</option>
			<option value="H" id="divH_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H</option>
			<option value="I" id="divI_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I</option>
			<option value="J" id="divJ_2" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J</option>										
		</select>
	</b>
	...
	<div class="table-wrapper" id="table123">
		...
		<p><b>
			...
			<select id="section">
				<option disabled selected value value="base">Choose Section</option>
				<!-- <option value="All">All</option> -->
				<option value="A" id="divA" style="display: none;">A</option>
				<option value="B" id="divB" style="display: none;">B</option>
				...
				<option value="F" id="divF" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F</option>
				<option value="G" id="divG" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G</option>
				<option value="H" id="divH" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H</option>
				<option value="I" id="divI" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I</option>
				<option value="J" id="divJ" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J</option>	
				<option value="A1" id="divA1" style="display: none;">A1</option>
				<option value="A2" id="divA2" style="display: none;">A2</option>
				<option value="A3" id="divA3" style="display: none;">A3</option>
				<option value="A4" id="divA4" style="display: none;" <?php if($dept_id==6){ ?> hidden <?php } ?>>A4</option>
				<option value="B1" id="divB1" style="display: none;">B1</option>
				<option value="B2" id="divB2" style="display: none;">B2</option>
				<option value="B3" id="divB3" style="display: none;">B3</option>
				...
				<option value="F1" id="divF1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F1</option>
				<option value="F2" id="divF2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F2</option>
				<option value="F3" id="divF3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F3</option>
				<option value="G1" id="divG1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G1</option>
				<option value="G2" id="divG2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G2</option>
				<option value="G3" id="divG3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G3</option>
				<option value="H1" id="divH1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H1</option>
				<option value="H2" id="divH2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H2</option>
				<option value="H3" id="divH3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H3</option>
				<option value="I1" id="divI1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I1</option>
				<option value="I2" id="divI2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I2</option>
				<option value="I3" id="divI3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I3</option>
				<option value="J1" id="divJ1" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J1</option>
				<option value="J2" id="divJ2" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J2</option>
				<option value="J3" id="divJ3" style="display: none;" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J3</option>
			</select>
		</b>
								...
								<div style="width: 100%"  id="showStudent">
									...
									<p><b>
										...
										<select id="sectionOFStudent">
											...
											<option value="F" id="divF_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>F</option>
											<option value="G" id="divG_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>G</option>
											<option value="H" id="divH_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>H</option>
											<option value="I" id="divI_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>I</option>
											<option value="J" id="divJ_1" <?php if($dept_id!=6){ ?> hidden <?php } ?>>J</option>										
										</select>
									</b>
