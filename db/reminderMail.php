...
function sendReminderMail($email,/* $fname, $lname,*/ $mail_message, $cc){
	...
	$mail->Username = 'fmss-kjsce@somaiya.edu';					//Sets SMTP username
	$mail->Password = 'YesItsFMSS1';					//Sets SMTP password
	$mail->SMTPSecure = 'tls';							//Sets connection prefix. Options are "", "ssl" or "tls"
	$mail->From = 'fmss-kjsce@somaiya.edu';			//Sets the From email address for the message
