...
$flag=0;
if($status==0){
	$sql_student = "SELECT flag0 FROM student WHERE roll_no = '$roll_no' ORDER BY `student`.`sem` ASC";
	...
	$sql_student = "SELECT flag1 FROM student WHERE roll_no = '$roll_no' ORDER BY `student`.`sem` ASC";
	$result_student = $conn->query($sql_student);
