...
<table class="table table-bordered" id="myTable2">
  <thead>
    <tr>
      ...
      <th width="40px;">Batch</th>
      <th width="200px;">Student Name</th>
      <th width="160px">Student Email</th>
   ...
   <tr>
    ...
    <td id="mail_id" style="text-align:left"><?= $email?></td>
...
<table id="mail_message">
  <tr>
    <td contenteditable="true" style="text-align: left;background-color: rgb(206,237,244); height:100px; vertical-align: top; font-size: 17px;">Dear Student,<br><br> Kindly note that, You have not filled/Completed the Faculty Feedback. <br><br> Please fill in the Faculty Feedback forms through the following link. <br><br> https://lms-kjsce.somaiya.edu/facultyfeedback. Using Google Sign In. <br><br>Thanks & Regards,<br> Faculty Feedback Committee,<br> KJSCE.</td>
  </tr>
</table>
